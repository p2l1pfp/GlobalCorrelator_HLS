...
bool had_equals(const HadCaloObj &out_ref, const HadCaloObj &out, const char *what, int idx) {
    bool ret = (out_ref.hwPt == out.hwPt && out_ref.hwEmPt == out.hwEmPt && out_ref.hwEta == out.hwEta && out_ref.hwPhi == out.hwPhi && out_ref.hwIsEM  == out.hwIsEM);
    if  (!ret) {
...
bool em_equals(const EmCaloObj &out_ref, const EmCaloObj &out, const char *what, int idx) {
    bool ret = (out_ref.hwPt == out.hwPt && out_ref.hwPtErr == out.hwPtErr && out_ref.hwEta == out.hwEta && out_ref.hwPhi == out.hwPhi);
    if  (!ret) {
...
bool track_equals(const TkObj &out_ref, const TkObj &out, const char *what, int idx) {
    bool ret = (out_ref.hwPt == out.hwPt && out_ref.hwPtErr == out.hwPtErr && out_ref.hwEta == out.hwEta && out_ref.hwPhi == out.hwPhi && out_ref.hwZ0  == out.hwZ0 && out_ref.hwCharge  == out.hwCharge && out_ref.hwTightQuality  == out.hwTightQuality);
    if  (!ret) {
...
bool pf_equals(const PFChargedObj &out_ref, const PFChargedObj &out, const char *what, int idx) {
    bool ret = (out_ref.hwPt == out.hwPt && out_ref.hwEta == out.hwEta && out_ref.hwPhi == out.hwPhi && out_ref.hwId  == out.hwId && out_ref.hwZ0  == out.hwZ0);
    if  (!ret) {
...
bool pf_equals(const PFNeutralObj &out_ref, const PFNeutralObj &out, const char *what, int idx) {
    bool ret = (out_ref.hwPt == out.hwPt && out_ref.hwEta == out.hwEta && out_ref.hwPhi == out.hwPhi && out_ref.hwId  == out.hwId);
    if  (!ret) {
