...
add_files converter/firmware/tk_input_converter.cpp -cflags "-DTESTMP7 -DHLS_pipeline_II=2"
add_files -tb tmux_full_create_test.cpp  -cflags "-DTESTMP7 -DHLS_pipeline_II=2 -DMP7_TOP_FUNC=${l1pfTopFunc} -DMP7_REF_FUNC=${l1pfRefFunc} -DMP7_VALIDATE=${l1pfValidate}"
