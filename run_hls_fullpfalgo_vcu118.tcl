...
add_files -tb pattern_serializer.cpp -cflags "-DTESTMP7 -DVCU118"
add_files -tb test_utils.cpp -cflags "-DTESTMP7 -DVCU118"
add_files -tb DiscretePFInputs.h    -cflags "-DTESTMP7 -DVCU118 -std=c++0x"
add_files -tb DiscretePFInputs_IO.h -cflags "-DTESTMP7 -DVCU118 -std=c++0x"
