...
source config_hls_hgcpfalgo_mp7.tcl

# open the project, don't forget to reset
open_project -reset "l1pfpuppi-hgc-resource-test"
set_top ${l1pfTopFunc}
add_files firmware/simple_hgcpfalgo.cpp -cflags "-DTESTMP7 -DHLS_pipeline_II=2"
add_files puppi/firmware/simple_puppi.cpp -cflags "-DTESTMP7 -DHLS_pipeline_II=2"
add_files -tb hgcpfalgo_test.cpp  -cflags "-DTESTMP7 -DHLS_pipeline_II=2 -DMP7_TOP_FUNC=${l1pfTopFunc} -DMP7_REF_FUNC=${l1pfRefFunc} -DMP7_VALIDATE=${l1pfValidate}"
add_files -tb simple_hgcpfalgo_ref.cpp -cflags "-DTESTMP7"
